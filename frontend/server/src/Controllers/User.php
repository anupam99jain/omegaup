 ...
 * @psalm-type LoginDetailsPayload=array{facebookUrl?: string, githubUrl?: string, hasVisitedSection?: bool, statusError?: string, validateRecaptcha: bool, verifyEmailSuccessfully?: string} 
        ...
        $response = [
            'templateProperties' => [
                'payload' => [
                    ...
                    'githubUrl' => \OmegaUp\Controllers\Session::getGitHubLoginUrl(),
